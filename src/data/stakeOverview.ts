...
export const stakeOverviewData: StakeOverviewData = {
  ...
  wardPerformance: [
    { ward: 'Batasan 1st', attendance: 107, converts: 22, templeReady: 47, missionaryCandidates: 0, ministering: 0, status: 'Stable' },
    { ward: 'Batasan 2nd', attendance: 127, converts: 13, templeReady: 58, missionaryCandidates: 0, ministering: 0, status: 'Stable' },
    { ward: 'Bagong Silangan', attendance: 98, converts: 14, templeReady: 44, missionaryCandidates: 0, ministering: 0, status: 'Stable' },
    { ward: 'Don Antonio', attendance: 155, converts: 6, templeReady: 63, missionaryCandidates: 0, ministering: 0, status: 'Strong' },
    { ward: 'Fairview', attendance: 144, converts: 31, templeReady: 64, missionaryCandidates: 0, ministering: 0, status: 'Stable' },
    { ward: 'Kalayaan', attendance: 205, converts: 13, templeReady: 88, missionaryCandidates: 0, ministering: 0, status: 'Strong' },
    { ward: 'Mapayapa', attendance: 130, converts: 15, templeReady: 57, missionaryCandidates: 0, ministering: 0, status: 'Stable' },
  ],
  monthlyGrowth: [
